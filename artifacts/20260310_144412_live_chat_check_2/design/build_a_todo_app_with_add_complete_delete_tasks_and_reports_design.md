...
### Story
- Title: Build a todo app with add, complete, delete tasks and reports
- Component: build_a_todo_app_with_add_complete_delete_tasks_and_reports
- Goal: Build a todo app with add, complete, delete tasks and reports
